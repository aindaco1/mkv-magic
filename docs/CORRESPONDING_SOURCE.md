...
- checksum-pinned FFmpeg, MKVToolNix, and Qt source archives corresponding to
  the distributed media runtime;
...
- `SOURCES.json`, which records versions, upstream URLs, hashes, licenses, and
  the network-disabled FFmpeg configuration boundary.
