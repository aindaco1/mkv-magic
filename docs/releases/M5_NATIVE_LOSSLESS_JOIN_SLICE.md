...
- Common-format choice controls and final stream/chapter assembly. The proposal,
  fused one-generation command compiler, and revision-bound verification/commit
  of its encoded-only intermediate bundle are implemented in
