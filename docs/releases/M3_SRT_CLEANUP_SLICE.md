...
- External subtitle matching, track metadata preview, verified muxing, embedded
  subtitle extraction/cleanup/remux, and corresponding workflow actions.
