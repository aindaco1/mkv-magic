...
let package = Package(
    ...
    products: [
        ...
        .executable(
            name: "MKVMagicAppBaselineProbe",
            targets: ["MKVMagicAppBaselineProbe"]
        ),
    ],
    dependencies: [
    ...
    targets: [
        ...
        .executableTarget(
            name: "MKVMagicAppBaselineProbe",
            dependencies: ["MKVMagicCore", "MKVMagicPerformance", "MKVMagicSystem"]
        ),
        .executableTarget(
            name: "MKVMagic",
            dependencies: [
        ...
        .testTarget(
            ...
            dependencies: ["MKVMagicCore", "MKVMagicPerformance"]
        ),
        .testTarget(
