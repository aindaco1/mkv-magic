...
public enum SavedWorkflowAction: String, Codable, CaseIterable, Hashable, Sendable {
    ...
    public var minimumSchemaVersion: Int {
        ...
        case .markAudioDescriptionTracks: 16
        default: 1
        }
    }
    ...
    public var displayName: String {
        ...
        case .markAudioDescriptionTracks: "If useful: Mark audio-description tracks"
    ...
    public var explanation: String {
        ...
        case .markAudioDescriptionTracks:
            "Mark audio tracks clearly named audio description, descriptive audio, or visually impaired with Matroska's visual-impaired flag; preserve names, playback flags, every other field, and all media packets."
        case .normalizeFilename:
